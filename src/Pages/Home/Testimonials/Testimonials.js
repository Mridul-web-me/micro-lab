                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body h-100">
                                <h5 className="card-title">Dr. Naresh Trehan</h5>
                                <p className="card-text">Dr. Naresh is a famous Indian cardiovascular and cardiothoracic surgeon. He was born on August 12, 1946, in Delhi, India. He obtained a medical degree from King George’s Medical College in Lucknow.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
